 ...
 */
final class Version20200408092854 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP display_name, CHANGE last_name_prefix last_name_prefix VARCHAR(180) DEFAULT NULL, CHANGE token token VARCHAR(255) DEFAULT NULL, CHANGE activated_at activated_at DATETIME DEFAULT NULL');
