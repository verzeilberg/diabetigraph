 ...
 */
final class Version20210716214329 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image_type ADD image_id INT DEFAULT NULL, CHANGE width width INT DEFAULT NULL, CHANGE height height INT DEFAULT NULL');
        $this->addSql('ALTER TABLE image_type ADD CONSTRAINT FK_7EE4BDB73DA5256D FOREIGN KEY (image_id) REFERENCES image (id)');
        $this->addSql('CREATE INDEX IDX_7EE4BDB73DA5256D ON image_type (image_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE image_imagetypes (id INT NOT NULL, imageTypeId INT NOT NULL, UNIQUE INDEX UNIQ_9AF10483125F993 (imageTypeId), INDEX IDX_9AF10483BF396750 (id), PRIMARY KEY(id, imageTypeId)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE image_type DROP FOREIGN KEY FK_7EE4BDB73DA5256D');
        $this->addSql('DROP INDEX IDX_7EE4BDB73DA5256D ON image_type');
        $this->addSql('ALTER TABLE image_type DROP image_id, CHANGE width width INT DEFAULT NULL, CHANGE height height INT DEFAULT NULL');
        $this->addSql('ALTER TABLE product CHANGE product_group_id product_group_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE role CHANGE login_path_id login_path_id INT DEFAULT NULL');
