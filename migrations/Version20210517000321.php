 ...
 */
final class Version20210517000321 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image_type CHANGE width width INT DEFAULT NULL, CHANGE height height INT DEFAULT NULL, CHANGE file_name type VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX search_idx ON image_type');
        $this->addSql('ALTER TABLE image_type CHANGE width width INT DEFAULT NULL, CHANGE height height INT DEFAULT NULL, CHANGE type file_name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE UNIQUE INDEX search_idx ON image_type (file_name)');
        $this->addSql('ALTER TABLE product CHANGE product_group_id product_group_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE role CHANGE login_path_id login_path_id INT DEFAULT NULL');
